...
public class GraphBuildingHandler extends DefaultHandler {
    ...
    private String lastnodeway = "";
    private HashMap<String, String> toconnect;
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes)
        ...
        if (qName.equals("node")) {
            ...
            if (!lastnodeway.equals("")) {
                toconnect.put(lastnodeway, attributes.getValue("ref"));
            }
            lastnodeway = attributes.getValue("ref");
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        if (qName.equals("way")) {
            ...
            if (validway) {
                for (String k: toconnect.keySet()) {
                    GraphDB.Edge newedge = new GraphDB.Edge(k, toconnect.get(k));
                    g.addEdge(newedge);
                }
            }
            toconnect = null;
